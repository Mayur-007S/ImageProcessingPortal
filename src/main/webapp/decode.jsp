...
<body>
    <div class="container">
        ...
        <main>
            <section class="card">
                <h2>Upload an Image to Decode</h2>
                <form action="decode" method="post" enctype="multipart/form-data" id="decodeForm">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn primary">Decode Image</button>
                    </div>
                </form>
            </section>
            
            <section class="card info-card">
                <h2>What can be decoded?</h2>
                ...
                <div class="warning">
                    <p>Note: Only images encoded with this steganography tool can be properly decoded.</p>
                </div>
            </section>
        </main>
